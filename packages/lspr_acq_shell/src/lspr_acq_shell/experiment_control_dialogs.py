...
from lspr_ui import flow_tabler_icon, tabler_icon
from .reglo_icc import PUMP_DISPLAY_MAX_LENGTH, sanitize_pump_display_text
from .pump_plan import ACTIVE_PUMP_CHANNELS, PumpPlanStep
...
class ExperimentControlDialogs:
    ...
    def edit_pause_state(self, step: PumpPlanStep, anchor: QWidget | None = None) -> PumpPlanStep | None:
        ...
        pause_model = build_experiment_control_pause_model(
            self._parent, step, app_name=self._app_name, app_version=self._app_version
        )
